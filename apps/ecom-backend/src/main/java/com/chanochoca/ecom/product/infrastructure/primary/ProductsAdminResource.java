...
public class ProductsAdminResource {
  ...
  // Will use UUID specially with frontend because don't want that the user will know how many have in DB
  // Also with UUID won't be able to iterate with the URL
  @DeleteMapping
  @PreAuthorize("hasAnyRole('" + ROLE_ADMIN + "')")
