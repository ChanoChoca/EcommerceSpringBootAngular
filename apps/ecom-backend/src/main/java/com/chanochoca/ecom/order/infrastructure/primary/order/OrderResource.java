...
import com.chanochoca.ecom.order.domain.user.vo.*;
...
import static com.chanochoca.ecom.product.infrastructure.primary.ProductsAdminResource.ROLE_ADMIN;
...
public class OrderResource {
  ...
  public ResponseEntity<RestStripeSession> initPayment(@RequestBody List<RestCartItemRequest> items) {
    ...
    try {
      ...
      System.out.println(stripeSessionInformation);
      ...
      throw new CartPaymentException("Error while creating Stripe session: " + cpe.getMessage());
